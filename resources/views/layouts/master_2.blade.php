...
<div class="container-fluid p-0">
    ...
    <hr class="m-0 ml-5">
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="clients" style="overflow: hidden">
        <div class="w-100">
            <div class="block">
                <div class="row">
                    <div class="slider">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="education">
        <div class="w-100">
            ...
            <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
                <div class="resume-content">
                    <h3 class="mb-0">La Grande International College</h3>
                    <div class="subheading mb-3">Bachelor of Computer Application</div>
                    <p>GPA: 3.64</p>
                </div>
                <div class="resume-date text-md-right">
                    <span class="text-primary">June 2007 - November 2011</span>
                </div>
            </div>

            <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
                <div class="resume-content">
                    <h3 class="mb-0">Sagarmatha Higher Secondary School</h3>
                    <div class="subheading mb-3">Higher Secondary Schooling in Science</div>
                    <p>Percentage: 73.2%</p>
                </div>
                <div class="resume-date text-md-right">
        ...
        <div class="w-100">
            ...
            <ul class="fa-ul mb-0">
                <li>
                    ...
                    System Architecture and Design</li>
                <li>
                    <i class="fa-li fa fa-check"></i>
                    Backend API Development</li>
                <li>
                    <i class="fa-li fa fa-check"></i>
                    Handling a Team and tasks</li>
                <li>
                    <i class="fa-li fa fa-check"></i>
        ...
        <div class="w-100">
            ...
            <ul class="fa-ul mb-0">
                <li>
                    ...
                    Skype: sujit.baniya2011</li>
                <li>
                    <i class="fa-li fa fa-mail-bulk text-warning"></i>
                    hi@sujitbaniy.com</li>
                <li>
                    <i class="fa-li fa fa-phone text-warning"></i>
                    +9779856034616</li>
            </ul>
        </div>
    </section>
